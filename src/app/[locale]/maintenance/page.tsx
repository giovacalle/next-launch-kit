...
export default function Maintenance() {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-100 to-purple-100">
      <div className="space-y-6 text-center">
        ...
        <p className="text-lg italic text-gray-700">&quot;{t('maintenance.quote')}&quot;</p>
      </div>
    </div>
  );
}
