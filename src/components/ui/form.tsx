...
function FormItem({
  ...
  return (
    <FormItemContext.Provider value={{ id }}>
      <div ref={ref} className={cn('w-full space-y-2', className)} {...rest} />
    </FormItemContext.Provider>
  );
}
FormItem.displayName = 'FormItem';

function FormLabel({ className, ref, ...rest }: ComponentPropsWithRef<typeof LabelPrimitive.Root>) {
...
function FormControl({ ref, ...rest }: ComponentPropsWithRef<typeof Slot>) {
